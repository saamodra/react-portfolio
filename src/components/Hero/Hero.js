        ...
        <div className="hero">
            ...
            <aside className="hero-left">
                <ul className="hero-contact">
                    <li>
                        <a href="https://github.com/saamodra" target="_blank" rel="noreferrer"><i className="fab fa-github"></i></a>
                    </li>
                    <li>
                        <a href="https://www.linkedin.com/in/saamodra/"><i className="fab fa-linkedin"></i></a>
                    </li>
                    <li>
                        <a href="https://instagram.com/saamodra/"><i className="fab fa-instagram"></i></a>
                    </li>
                    <li>
                        <a href="https://twitter.com/saamodra/"><i className="fab fa-twitter"></i></a>
                    </li>
                </ul>
            </aside>
